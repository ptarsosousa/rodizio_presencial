...
st.write(f'Quer saber mais sobre modelagem linear (programação)? Então comece por aqui: {st.page_link("https://pt.wikipedia.org/wiki/Programa%C3%A7%C3%A3o_linear", label="Programação Linear", icon="🌎")})
st.page_link
st.markdown('''
